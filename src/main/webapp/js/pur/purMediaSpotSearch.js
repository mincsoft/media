...
var urlSearchMedia="/script-api/customopenapi/search-purcontractspot";//查询合同排期数据
var urlSaveMedia="/script-api/customopenapi/save-purcontractspot";//保存
...
$(function(){
    ...
    if ("dev"==debug){
        ...
        urlSearchMedia="/json/purContractSpotSearch.jsp";
        urlSaveMedia="/json/purContractSpotSave.jsp";
    }
